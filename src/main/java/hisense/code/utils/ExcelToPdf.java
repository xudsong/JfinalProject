...
public class ExcelToPdf {  
    ...
    public static void excelToPdf(File file) throws DocumentException, IOException {  
        Document document = new Document(PageSize.A3,0,0,0,0);  
        PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(
        		PathKit.getWebRootPath() + File.separator + "upload" + File.separator+"table"+File.separator+"11.pdf"));  
        ...
        BaseFont bf=BaseFont.createFont(PathKit.getWebRootPath() + File.separator + "upload" + File.separator+"fonts"+File.separator+"simkai.ttf", BaseFont.IDENTITY_H, false);    
